...
import KaguraChannelRaw from "./KaguraChannelRaw";

export default class KaguraChannel extends ChannelComponent<KaguraChannelRaw>{
	...
	protected Initialization(): KaguraChannelRaw {
		return {
			chats: []
		};
	}
	protected Installation(raw: KaguraChannelRaw) {
		this._chats = raw.chats;
	}
	public Raw(): KaguraChannelRaw {
		return {
			chats: this._chats
		};
	}
